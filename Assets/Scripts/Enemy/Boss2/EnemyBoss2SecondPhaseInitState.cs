...
public class EnemyBoss2SecondPhaseInitState : EnemyState
{
    public EnemyBoss2SecondPhaseInitState(EnemyStateMachine enemyStateMachine) : base(enemyStateMachine) { }
