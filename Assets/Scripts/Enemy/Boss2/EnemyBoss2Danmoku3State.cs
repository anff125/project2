...
public class EnemyBoss2Danmoku3State : EnemyState
{
    public EnemyBoss2Danmoku3State(EnemyStateMachine enemyStateMachine) : base(enemyStateMachine) { }
    ...
    public override void Enter()
    {
        ...
        EnemyStateMachine.EnemyBoss2.danmokuCount3++;
    }
    private IEnumerator FireWithDelay()
    {
        ...
        EnemyStateMachine.EnemyBoss2.bulletEmitters[0].PlayAnimationMultipleTimes(3, 1, out float clipLength);
