...
public class EnemyBoss2Danmoku5State : EnemyState
{
    public EnemyBoss2Danmoku5State(EnemyStateMachine enemyStateMachine) : base(enemyStateMachine) { }
    ...
    private IEnumerator FireWithDelay()
    {
        ...
        EnemyStateMachine.EnemyBoss2.bulletEmitters[0].PlayAnimationMultipleTimes(5, 3, out float clipLength);
