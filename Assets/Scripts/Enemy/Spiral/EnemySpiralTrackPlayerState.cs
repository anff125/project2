...
public class EnemySpiralTrackPlayerState : EnemyState
{
    public EnemySpiralTrackPlayerState(EnemyStateMachine enemyStateMachine) : base(enemyStateMachine) { }
    ...
    public override void Update()
    {
        ...
        if (spiralEnemy != null)
        {
            EnemyStateMachine.ChangeState(spiralEnemy.ShootState);
        }
